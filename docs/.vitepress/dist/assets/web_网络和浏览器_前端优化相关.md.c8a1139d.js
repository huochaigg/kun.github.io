...
<span class="line"><span style="color:#24292e;">    },</span></span>
<span class="line"><span style="color:#24292e;">  },</span></span>
<span class="line"><span style="color:#24292e;">});</span></span></code></pre></div><h2 id="使用缓存" tabindex="-1">使用缓存 <a class="header-anchor" href="#使用缓存" aria-label="Permalink to &quot;使用缓存&quot;">​</a></h2><h3 id="http缓存" tabindex="-1">HTTP缓存 <a class="header-anchor" href="#http缓存" aria-label="Permalink to &quot;HTTP缓存&quot;">​</a></h3><h3 id="service-worker-pwa" tabindex="-1">Service Worker（PWA） <a class="header-anchor" href="#service-worker-pwa" aria-label="Permalink to &quot;Service Worker（PWA）&quot;">​</a></h3><h3 id="路由-组件级别的缓存" tabindex="-1">路由，组件级别的缓存 <a class="header-anchor" href="#路由-组件级别的缓存" aria-label="Permalink to &quot;路由，组件级别的缓存&quot;">​</a></h3><h2 id="使用cdn" tabindex="-1">使用CDN <a class="header-anchor" href="#使用cdn" aria-label="Permalink to &quot;使用CDN&quot;">​</a></h2><h2 id="预加载页面" tabindex="-1">预加载页面 <a class="header-anchor" href="#预加载页面" aria-label="Permalink to &quot;预加载页面&quot;">​</a></h2>`,64),o=[p];function c(t,i,r,d,h,y){return n(),a("div",null,o)}const b=s(l,[["render",c]]);export{g as __pageData,b as default};
